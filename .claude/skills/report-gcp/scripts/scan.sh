...
write_inventory() {
  ...
  local n_net n_sub n_fw n_vm n_mig n_ig n_disk n_snap n_gke n_run n_fn n_ae n_lb n_be n_sql n_alloydb n_memcached n_bq n_bucket n_fs n_sa n_alert n_zone n_pstopic n_pssub n_dataflow n_dataproc
